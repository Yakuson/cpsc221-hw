...
class BinaryTree
{
  ...
  private:
    ...
    * helper i created
    */
    void printLeftToRightsubroot(const Node* subroot) const;
    /*
    * helper i created
    */
    ...
    * helper i created
    */  
    int sumAllDistances(Node* subroot, int count) const;
    /*
    * helper i created
    */  
    void printAllPaths(Node *subroot, string path) const;
    /*
    * helper i created
    */    
    bool isOrdered(Node* subroot, Node* min, Node* max) const;
